...
<a href="docs/fr/README_fr.md">Français</a>|
<a href="docs/zh/README_zh_tw.md">Traditional Chinese</a>
</p>
...
For details, please see [Contribution Guide](docs/zh/CONTRIBUTING_upstream.md).
...
Full attribution to the original authors is preserved in **[CREDITS.md](docs/en/CREDITS.md)** ([简体中文](docs/zh/CREDITS_zh.md) · [Setswana](docs/tn/CREDITS_tn.md)) — kept in-repo because the upstream `win12-online/win12` and its contributor graph are no longer publicly available.
