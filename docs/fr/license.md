...
> 🌐 English : [../en/license.md](../en/license.md)

win12 est sous double licence, suivant le projet amont :
...
- Utilisez les termes de **Creative Commons** (voir `LICENSE-CC`) pour les œuvres,
  images et autres contenus créatifs.

Ce fork conserve les licences amont. En cas de redistribution, conservez les deux
fichiers de licence et l'attribution qu'ils exigent. Les marques Microsoft et le
nom « Windows » appartiennent à Microsoft ; ceci est une simulation
