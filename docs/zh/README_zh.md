...
_AI Copilot([相关信息](../../src/scripts/AI%20Copilot%20service/README.md))_
...
详情请见 [贡献指南](CONTRIBUTING_upstream.md)。
...
原作者的完整署名保存在 **[CREDITS.md](../en/CREDITS.md)**（[English](../en/CREDITS.md) · [简体中文](CREDITS_zh.md) · [Setswana](../tn/CREDITS_tn.md)）——因上游 `win12-online/win12` 及其贡献者图谱已无法公开访问，故在本仓库内保留。
