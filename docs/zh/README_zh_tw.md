...
*AI Copilot([實作方法](../../src/scripts/AI%20Copilot%20service/README.md))*
## 前景規劃
...
詳情請見 [貢獻指南](CONTRIBUTING_upstream.md)。

本專案使用 i18n 函式庫實現多語言，翻譯工作依據[翻譯貢獻指南](../../src/lang/lang/readme.md)進行。
